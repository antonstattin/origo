...
class ControlShape(object):
    ...
    def circle(transform):
        ...
        pm.setAttr("%s.rotateX"%circle, 90)

        pm.makeIdentity(circle, a=True)

        cornerA = [[-0.9773152479267851, 2.0311082641997424e-08, -0.20475365579346108], [-0.9773152479267851, -0.0935698853332871, -0.09796153122808283],
                   [-0.9773152479267851, -0.0935698853332871, 0.0], [-0.9773152479267851, -0.0935698853332871, 0.09796153122808283],
                   [-0.9773152479267851, 2.0311082641997424e-08, 0.20475365579346108], [-0.9773152479267851, 0.0935699259554525, 0.09796153122808283],
                   [-0.9773152479267851, 0.0935699259554525, 0.0], [-0.9773152479267851, 0.0935699259554525, -0.09796153122808283], [-0.9773152479267851, 2.0311082641997424e-08, -0.20475365579346108]]

        cornerB = [[-0.20475365579346086, 2.0311082641997424e-08, -0.9773152479267851], [-0.09796153122808261, -0.0935698853332871, -0.9773152479267851],
                    [2.1700757811311203e-16, -0.0935698853332871, -0.9773152479267851], [0.09796153122808306, -0.0935698853332871, -0.9773152479267851],
                    [0.2047536557934613, 2.0311082641997424e-08, -0.9773152479267851], [0.09796153122808306, 0.0935699259554525, -0.9773152479267851],
                    [2.1700757811311203e-16, 0.0935699259554525, -0.9773152479267851], [-0.09796153122808261, 0.0935699259554525, -0.9773152479267851],
                    [-0.20475365579346086, 2.0311082641997424e-08, -0.9773152479267851]]

        cornerC = [[0.9773152479267851, 2.0311082641997424e-08, -0.20475365579346097], [0.9773152479267851, -0.0935698853332871, -0.09796153122808271],
                    [0.9773152479267851, -0.0935698853332871, 1.1968659901314393e-16], [0.9773152479267851, -0.0935698853332871, 0.09796153122808296],
                    [0.9773152479267851, 2.0311082641997424e-08, 0.2047536557934612], [0.9773152479267851, 0.0935699259554525, 0.09796153122808296],
                    [0.9773152479267851, 0.0935699259554525, 1.1968659901314393e-16], [0.9773152479267851, 0.0935699259554525, -0.09796153122808271],
                    [0.9773152479267851, 2.0311082641997424e-08, -0.20475365579346097]]

        cornerD = [[0.2047536557934613, 2.0311082641997424e-08, 0.9773152479267851], [0.09796153122808306, -0.0935698853332871, 0.9773152479267851],
                   [2.1700757811311203e-16, -0.0935698853332871, 0.9773152479267851], [-0.09796153122808261, -0.0935698853332871, 0.9773152479267851],
                   [-0.20475365579346086, 2.0311082641997424e-08, 0.9773152479267851], [-0.09796153122808261, 0.0935699259554525, 0.9773152479267851],
                   [2.1700757811311203e-16, 0.0935699259554525, 0.9773152479267851], [0.09796153122808306, 0.0935699259554525, 0.9773152479267851],
                   [0.2047536557934613, 2.0311082641997424e-08, 0.9773152479267851]]

        cornerA_crv = pm.curve(d=1, p=cornerA, n=transform + 'CornerAShape')
        cornerB_crv = pm.curve(d=1, p=cornerB, n=transform + 'CornerBShape')
        cornerC_crv = pm.curve(d=1, p=cornerC, n=transform + 'CornerCShape')
        cornerD_crv = pm.curve(d=1, p=cornerD, n=transform + 'CornerDShape')

        for curve in [cornerA_crv, cornerB_crv, cornerC_crv, cornerD_crv]:
            pm.parent(pm.listRelatives(curve, s=True)[0], circle, r=True, s=True)
            pm.delete(curve)

        pm.setAttr("%s.rotateZ"%circle, 90)
        pm.makeIdentity(circle, a=True)
        for shp in pm.listRelatives(circle, s=True):
            pm.parent(shp, transform, s=True, r=True)
    ...
    @staticmethod
    def circledetail(transform):

        circlePartA = [[3.9480632915149316, 0.0, 0.8266724707239429], [3.9480632915149316, 0.0, 2.6981861734834007],
                        [2.556338452182758, 0.0, 4.133362353619717], [0.7896126583029867, 0.0, 4.1333623536197175]]

        circlePartB = [[-3.9480632915149316, 0.0, 0.8266724707239435], [-3.9480632915149316, 0.0, 2.6981861734834016],
                      [-2.5563384521827577, 0.0, 4.1333623536197175], [-0.7896126583029863, 0.0, 4.1333623536197175]]


        circlePartC = [[-3.9480632915149316, 0.0, -0.8266724707239435], [-3.9480632915149316, 0.0, -2.6981861734834016],
                      [-2.5563384521827577, 0.0, -4.1333623536197175], [-0.7896126583029863, 0.0, -4.1333623536197175]]

        circlePartD = [[3.9480632915149316, 0.0, -0.8266724707239429], [3.9480632915149316, 0.0, -2.6981861734834007],
                       [2.556338452182758, 0.0, -4.133362353619717], [0.7896126583029867, 0.0, -4.1333623536197175]]

        cornerA = [[-0.7855345443589526, 0.0, 4.124000705010845], [-0.7855345443589526, 0.0, 4.642971232216287],
                   [-0.2665640171535053, 0.4109226864029621, 4.637542659990627], [0.2524065100519418, 0.4109226864029621, 4.637542659990627],
                   [0.7713770372573897, 0.0, 4.642971232216287], [0.7713770372573897, 0.0, 4.124000705010845]]


        cornerB = [[3.948063373565674, 8.205074220057895e-08, -0.8271439648124634], [3.948063373565674, -0.37799454980033786, -0.3957354950518254],
                   [3.948063373565674, -0.37799454980033786, 0.0], [3.948063373565674, -0.37799454980033786, 0.3957354950518254],
                   [3.948063373565674, 8.205074220057895e-08, 0.8271439648124634], [3.948063373565674, 0.3779947139018227, 0.3957354950518254],
                   [3.948063373565674, 0.3779947139018227, 0.0], [3.948063373565674, 0.3779947139018227, -0.3957354950518254], [3.948063373565674, 8.205074220057895e-08, -0.8271439648124634]]


        cornerC = [[-0.7855345443589526, 0.0, -4.124000705010845], [-0.7855345443589526, 0.0, -4.642971232216287],
                   [-0.2665640171535053, 0.4109226864029621, -4.637542659990627], [0.2524065100519418, 0.4109226864029621, -4.637542659990627],
                   [0.7713770372573897, 0.0, -4.642971232216287], [0.7713770372573897, 0.0, -4.124000705010845]]


        cornerD = [[-3.948063373565674, 8.205074220057895e-08, -0.8271439648124634], [-3.948063373565674, -0.37799454980033786, -0.3957354950518254],
                   [-3.948063373565674, -0.37799454980033786, 0.0], [-3.948063373565674, -0.37799454980033786, 0.3957354950518254],
                   [-3.948063373565674, 8.205074220057895e-08, 0.8271439648124634], [-3.948063373565674, 0.3779947139018227, 0.3957354950518254],
                   [-3.948063373565674, 0.3779947139018227, 0.0], [-3.948063373565674, 0.3779947139018227, -0.3957354950518254], [-3.948063373565674, 8.205074220057895e-08, -0.8271439648124634]]
        ...
        # build half circles
        circlePartA_crv = pm.curve(d=3, p=circlePartA, name=transform + 'CirclePartAShape')
        circlePartB_crv = pm.curve(d=3, p=circlePartB, name=transform + 'CirclePartBShape')
        circlePartC_crv = pm.curve(d=3, p=circlePartC, name=transform + 'CirclePartCShape')
        circlePartD_crv = pm.curve(d=3, p=circlePartD, name=transform + 'CirclePartDShape')


        # build Corners
        cornerA_crv = pm.curve(d=1, p=cornerA, name=transform + 'CornerPartAShape')
        cornerB_crv = pm.curve(d=1, p=cornerB, name=transform + 'CornerPartBShape')
        cornerC_crv = pm.curve(d=1, p=cornerC, name=transform + 'CornerPartCShape')
        cornerD_crv = pm.curve(d=1, p=cornerD, name=transform + 'CornerPartDShape')

        # parent circle part
        for curve in [circlePartA_crv, circlePartB_crv, circlePartC_crv, circlePartD_crv]:
            pm.parent(pm.listRelatives(curve, s=True)[0], transform, r=True, s=True)
            pm.delete(curve)

        # parent detailed corner parts
        for curve in [cornerA_crv, cornerB_crv, cornerC_crv, cornerD_crv]:
            pm.parent(pm.listRelatives(curve, s=True)[0], transform, r=True, s=True)
            pm.delete(curve)
